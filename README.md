# Projeto-LP2A4
Este é um projeto feito por Gustavo Massamichi Nakamura e Guilherme. 
...
Assim que finalizar, nos avise pelo e-mail vagas-dev@juntossomosmais.com.br para enviarmos os usuários que devem ter acesso para avaliação -> No caso de nós alunos que estamos realizando o desafio através da matéria de LP2A4, será enviado pela plataforma do Instituto Federal de Educação, Ciência e Tecnologia de São Paulo chamado Moodle.
